# filepath: c:\GitHub\Data_Insights\src\backend\data\models\data_models.py
"""
This module defines Pydantic models for data validation and structuring.
These models ensure data consistency across the application, particularly
for data returned by backend processing functions.
"""
